...
class Ftp
{
    ...
    {
        $config = Config::get('IMAGE_SERVE_CONFIG');
    ...
    public function file_exists($path)
    {
        ...
        $file_size = ftp_size($this->conn_id, $path);
    ...
    public function upload($localpath, $remotepath, $mode = 'auto', $permissions = NULL)
    {
        ...
        if ($pathinfo['dirname'] !== '.') {
            $dirinfo = explode('/', $pathinfo['dirname']);
        ...
        $result = @ftp_put($this->conn_id, $filename, $localpath, $mode);
        ...
        if (!is_null($permissions)) {
            $this->chmod($filename, (int)$permissions);
        }
